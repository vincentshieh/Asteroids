(function () {
  ...
  Game.prototype.introScreen = function () {
    ...
    this.ctx.fillText("Asteroids", 390, 325);
    this.ctx.font = "bold 24px Arial";
    this.ctx.fillText("Press space to start", 385, 360);
    this.ctx.fillText("Use arrow keys to navigate your ship", 290, 390);
    this.ctx.fillText("Use space bar to fire bullets at asteroids", 270, 420);
  };
